<div>
    ...
    @if (!is_null($selectedCountry))
        <div class="form-group row">
            ...
            {{-- @dump($states) --}}
            <div class="col-md-6">
                <select wire:model="selectedState" class="form-control" name="">
    ...
    @if (!is_null($selectedState))
        <div class="form-group row">
            ...
            {{-- @dump($cities) --}}
            <div class="col-md-6">
                <select wire:model="selectedCity" class="form-control" name="village_id" id="village_id">
