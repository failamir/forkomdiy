<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('dataUmum.nama_lembaga') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="text" name="nama_lembaga" id="nama_lembaga"
            wire:model.defer="dataUmum.nama_lembaga">
    ...
    <div class="form-group {{ $errors->has('dataUmum.ketua_id') ? 'invalid' : '' }}">
        ...
        <x-select-list class="form-control" id="ketua" name="ketua" :options="$this->listsForFields['ketua']"
            wire:model="dataUmum.ketua_id" />
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('dataUmum.sekretariat_wilayah') ? 'invalid' : '' }}">
        <label class="form-label"
            for="sekretariat_wilayah">{{ trans('cruds.dataUmum.fields.sekretariat_wilayah') }}</label>
        <input class="form-control" type="text" name="sekretariat_wilayah" id="sekretariat_wilayah"
            wire:model.defer="dataUmum.sekretariat_wilayah">
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('dataUmum.whats_app') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="text" name="whats_app" id="whats_app"
            wire:model.defer="dataUmum.whats_app">
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('dataUmum.lingkup_kegiatan') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="text" name="lingkup_kegiatan" id="lingkup_kegiatan"
            wire:model.defer="dataUmum.lingkup_kegiatan">
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('dataUmum.perizinan_id') ? 'invalid' : '' }}">
        ...
        <x-select-list class="form-control" id="perizinan" name="perizinan" :options="$this->listsForFields['perizinan']"
            wire:model="dataUmum.perizinan_id" />
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('dataUmum.jumlah_anggota') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="number" name="jumlah_anggota" id="jumlah_anggota"
            wire:model.defer="dataUmum.jumlah_anggota" step="1">
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('mediaCollections.data_umum_lampiran') ? 'invalid' : '' }}">
        ...
        <x-dropzone id="lampiran" name="lampiran" action="{{ route('admin.data-umums.storeMedia') }}"
            collection-name="data_umum_lampiran" max-file-size="52" />
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('dataUmum.province_id') ? 'invalid' : '' }}">
        ...
        <x-select-list class="form-control" id="province" name="province" :options="$this->listsForFields['province']"
            wire:model="dataUmum.province_id" />
        <div class="validation-message">
